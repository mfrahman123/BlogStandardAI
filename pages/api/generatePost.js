...
export default withApiAuthRequired(async function handler(req, res) {
    ...
    if(topic.length > 100 || keywords.length > 80) {
        res.status(422);
        return;
    }
    ...
    const metaDescriptionResponse = await openai.createChatCompletion({
        ...
        role:"user",
        content:"Generate SEO-friendly meta description content for the above blog post, limited to the following HTML tags: p, h1, h2, h3, h4, h5, h6, strong, li, ol, ul, i. Please do not include in meta description HTML tags."
    }]
    })
